...
- A complete Convex schema covering all domain tables plus Convex Auth tables
...
22. As a developer, I want the Convex schema to define all domain tables with their fields, union types, and indexes, so that downstream PRDs can write queries and mutations without modifying the schema.
