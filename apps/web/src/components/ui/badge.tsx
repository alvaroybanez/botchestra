...
const badgeVariants = cva(
  "inline-flex items-center rounded-full border px-2.5 py-0.5 font-label text-[10px] transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2",
  {
    variants: {
      variant: {
        default:
