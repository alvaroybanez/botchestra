      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          <p className="max-w-2xl text-sm leading-6 text-muted-foreground">
            Create or publish a persona configuration before launching a new
            study. The creation wizard needs a persona configuration to supply
            persona coverage.
          </p>
  ...
  return (
    <section className="space-y-6">
      <PageHeader
        eyebrow="Study Setup"
        title="Create a new study"
        description="Configure the persona configuration, task specification, run budget, concurrency, and guardrails for the study launch workflow."
      />
      ...
      <form className="space-y-6" onSubmit={handleSubmit}>
        <Card>
          ...
          <CardContent className="grid gap-6">
            <div className="grid gap-4 md:grid-cols-2">
              <Field>
                <Label htmlFor="study-persona-config">
                  Persona configuration selector
                </Label>
                <select
            ...
            <div className="grid gap-4 md:grid-cols-2">
              ...
              <Field>
                <Label htmlFor="study-active-concurrency">
                  Active concurrency
                </Label>
                <Input
            ...
            <div className="grid gap-4 md:grid-cols-2">
              <Field>
                <Label htmlFor="study-environment-label">
                  Environment label
                </Label>
                <select
        ...
        <Card>
          ...
          <CardContent className="grid gap-4 md:grid-cols-2">
            ...
            />
            <SummaryValue label="Locale" variant="bordered" value="en-US" />
            <SummaryValue
              label="Viewport"
              variant="bordered"
              value="1440 \u00d7 900"
