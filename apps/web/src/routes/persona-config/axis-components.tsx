...
import type { AxisDefinition, AxisFormValue, SuggestedAxisState } from "./types";
import { textareaClassName } from "./helpers";
import { AxisInput, LocalSummaryValue } from "./shared-ui";
        ...
        >
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <AxisInput
              ...
              onChange={(value) =>
                onChange({ ...suggestion.axis, label: value })
              }
            />
            <AxisInput
                ...
                return (
                  ...
                  >
                    ...
                    <div className="text-right text-xs text-muted-foreground">
                      {isDuplicate
                        ? "Already in persona configuration"
                        : "Ready to import"}
                    </div>
                  </label>
                );
