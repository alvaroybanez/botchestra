...
function createRequest(): ExecuteRunRequest {
  return {
    runId: "run_self_report_openai_key_wiring",
    studyId: "study_self_report_openai_key_wiring",
    personaVariant: {
      id: "pv_001",
...
describe("createExecuteRunHandler self-report OPENAI_API_KEY wiring", () => {
  it("passes env.OPENAI_API_KEY through the default self-report generator", async () => {
