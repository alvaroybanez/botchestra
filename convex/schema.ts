...
export default defineSchema({
  ...
  issueClusters: defineTable({
    ...
    affectedProtoPersonaIds: v.array(v.string()),
    affectedAxisRanges: v.array(axisRangeValidator),
    representativeRunIds: v.array(v.string()),
  ...
  studyReports: defineTable({
    ...
    issueClusterIds: v.array(v.string()),
  ...
  credentials: defineTable({
    ...
    description: v.string(),
    allowedStudyIds: v.optional(v.array(v.string())),
    createdBy: v.string(),
    createdAt: v.number(),
    updatedAt: v.number(),
  }),
